<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadManager.aspx.cs" Inherits="UploadManager" Theme="General" StylesheetTheme="General" %>
...
<body class="body">
    <form id="frmMain" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" HeaderStyle-BackColor="#3AC0F2" HeaderStyle-ForeColor="White"
            ...
            AutoGenerateColumns="False" style="margin-right: 0px" Width="478px">
